...
from comodit_client.control.pipeline import PipelineController
...
from comodit_client.control.pipeline_context import PipelineContextController
...
class OrganizationsController(RootEntityController):
    ...
    def __init__(self):
        ...
        self._register_subcontroller(["pipelines"], PipelineController())
        self._register_subcontroller(["pipelines-logs"], PipelineContextController())
